...
pictureLocation = homeFolder + "/Pictures/BingWallpaper/img/"
...
def main():
    ...
    url = "http://www.bing.com/HPImageArchive.aspx?format=js&idx="+str(day)+"&n=1&mkt=en-WW"
...
def process_url(image_url):
	...
	#print image_url.split('=')[-3][:-3]
        filename = pictureLocation + image_url.split('=')[-3][:-3]
